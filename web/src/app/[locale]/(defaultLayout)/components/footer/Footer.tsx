        ...
        <footer className='relative mt-24 flex flex-col items-center'>
            <div className='from-background to-tertiary-active flex h-[300px] w-full flex-col items-center justify-center gap-8 bg-gradient-to-b'>
                <div className='flex gap-8'>
                    <Link
                        href='/'
                        className='text-muted-foreground flex items-center gap-1 duration-200 hover:text-white'
                    >
                        <svg
                            role='img'
                            viewBox='0 0 24 24'
            ...
            <div className='bg-tertiary flex h-9 w-full justify-center'>
                <div className='flex max-w-lg items-center'>
                    <p className='text-muted-foreground'>
                        Designed by{' '}
                        <Link
                            href='https://github.com/Folsed'
                            target='_blank'
