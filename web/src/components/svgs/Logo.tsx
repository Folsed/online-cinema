type TLogoProps = React.SVGProps<SVGSVGElement>

const Logo: React.FC<TLogoProps> = props => {
    return (
        <svg viewBox='0 0 450 450' xmlns='http://www.w3.org/2000/svg' {...props}>
            <g id='svgGroup' strokeLinecap='round' fontSize='9pt' stroke='0'>
                <path
